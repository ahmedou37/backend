...
public class ExcepionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException e){
        ...
        e.getBindingResult().getAllErrors().forEach((error) -> {//When validation fails, Spring creates a BindingResult object that contains ALL the details about what went wrong
